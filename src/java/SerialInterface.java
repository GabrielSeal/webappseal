...
public class SerialInterface extends Thread implements SerialPortEventListener  {
	 ...
	 * @param rate
	 */
	public SerialInterface(String commPort,int rate) throws IOException, TooManyListenersException {
		super ();
		...
		try {
            ...
            inputStream = serialPort.getInputStream(); // TODO Auto-generated catch block
